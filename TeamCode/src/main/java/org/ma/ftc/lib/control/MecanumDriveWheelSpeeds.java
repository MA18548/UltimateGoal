...
public class MecanumDriveWheelSpeeds {
    ...
    public void normalize(double attainableMaxSpeedMetersPerSecond) {
        double realMaxSpeed = Math.max(frontLeftMetersPerSecond, frontRightMetersPerSecond);
        realMaxSpeed = Math.max(rearLeftMetersPerSecond, realMaxSpeed);
        realMaxSpeed = Math.max(rearRightMetersPerSecond, realMaxSpeed);
